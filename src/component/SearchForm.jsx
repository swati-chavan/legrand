...
const FormSearch = ({ onSelectRecord, onEditRecord }) => {
      ...
      <table className="w-full bg-white border-collapse">
        <thead className='rounded-lg '>
          <tr className="bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg ">
            ...
            <th className="w-[32%] px-4 py-3 text-left text-xs font-bold uppercase tracking-wider border-r border-blue-500/30">Submitted At</th>
            <th className="w-[10%] px-8 py-3 text-center text-xs font-bold uppercase tracking-wider">Actions</th>
          </tr>
        </thead>
        <tbody>
            ...
            >
              ...
              <td className="px-1 py-1 text-center">
                  <div className="flex items-center justify-center gap-2">
                        ...
                        className="px-3 py-1.5 bg-gradient-to-r from-cyan-500 to-cyan-600 text-white text-xs font-semibold rounded-md hover:from-cyan-600 hover:to-cyan-700 focus:outline-none focus:ring-2 focus:ring-cyan-300 shadow-sm hover:shadow-md transition-all duration-200"
                        >
                        View
                      </button>
                        <button 
                        onClick={() => onEditRecord(record)}
                        className="px-3 py-1.5 bg-green-600 text-white text-xs font-semibold rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-300 shadow-sm hover:shadow-md transition-all duration-200"
                        >
                      Edit
                      </button>
                      </div>
